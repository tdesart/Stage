...
public class ChatClient extends JFrame implements ActionListener {
	...
	// Sandro Reis: line replaced to avoid the "SE_BAD_FIELD" findBugs warning
	// private WebSocketClient cc;
	private transient WebSocketClient cc;

	/**
	 * @param defaultlocation
	 */
	public ChatClient( final String defaultlocation ) {
		...
		final Draft[] drafts = { new Draft_17(), new Draft_10(), new Draft_76(), new Draft_75() };
		...
		final java.awt.Dimension d = new java.awt.Dimension( 300, 400 );
		setPreferredSize( d );
		setSize( d );
