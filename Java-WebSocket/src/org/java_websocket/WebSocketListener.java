 ...
 * The methods within are called by <tt>WebSocket</tt>.<br>
 * Almost every method takes a first parameter conn which represents the source of the respective event.<br>
