 ...
 * @version 2.3.7
 */
@edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "DE_MIGHT_IGNORE", justification = "The idea here is exactly to ignore every exception in the finnally segment, to close every resource possible")
public class Base64
{
