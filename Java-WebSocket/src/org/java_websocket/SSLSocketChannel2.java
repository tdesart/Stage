...
/**
 * Implements the relevant portions of the SocketChannel interface with the SSLEngine wrapper.<br>
 * taken from TooTallNate website
...
public class SSLSocketChannel2 implements WrappedByteChannel {
	 ...
	 * @throws IOException
	 */
	public SSLSocketChannel2( final SelectionKey key , final SSLEngine sslEngine , final ExecutorService exec ) throws IOException {
