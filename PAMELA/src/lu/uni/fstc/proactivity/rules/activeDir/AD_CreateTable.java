...
public class AD_CreateTable extends AbstractRule {
	private String tableName;

	public AD_CreateTable(String tableName) {
	...
	protected void actions() {
		// TODO Auto-generated method stub
		((AbstractActiveDirWrapper) dataNativeSystem).createTable(this.tableName);
