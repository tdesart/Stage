 ...
 *
 */
public class PPR001m extends AbstractRuleMoodle{
	 ...
	 * @param assignment_id
	 * @param user_id
	 * @param submissionlevel 
	 */
	public PPR001m(final long assignment_id,final long user_id,final int submissionlevel) {
		this();
	...
	protected void actions() {
		...
		this.subject = "Notification: Assignment Submission level less than "+this.submissionlevel+"%";
		buf.append("This notification is related to your assignment '" + this.assignment_name + "' for the course '" + this.course_name + "'.\n");
		buf.append("There is a potential problem with the assignment submission level.\n");
		buf.append("The deadline for this assignment expires in a few days and its submission level is less than  "+this.submissionlevel+"%!\n");
	...
	public String toString() {
		return "PRB001m - inform the teacher about the problem concerning the assignment ID = " + this.assignment_id;
	}
	 ...
	 * @param submissionlevel
	 */
	public void setSubmissionlevel(final int submissionlevel) {
