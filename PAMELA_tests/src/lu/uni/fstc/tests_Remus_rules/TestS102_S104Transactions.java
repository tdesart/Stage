 ...
 *
 */
public class TestS102_S104Transactions {
...
//		Global.logger.info("AbstractMoodleDbWrapper was created as " + db.toString() + ".");
		...
		final S102 rule = new S102(781,"Master in Integrated Systems Biology (académique)", 2);
		...
		final S104 rule1 = new S104(781,"Master in Integrated Systems Biology (académique)", 2);
