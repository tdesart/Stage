 ...
 *
 */
public class TestRules_3rd_Stage {
...
/**/
	...
	public static void main(String[] args) throws Exception {
		...
		lu.uni.fstc.proactivity.rules.moodleCoPs.S301 rule = new lu.uni.fstc.proactivity.rules.moodleCoPs.S301(1519);
		rule.setEngine(new ProactiveEngine (db, dbPam));

		boolean ret = rule.execute();
		Global.logger.info("S301.execute() returned: " + ret);
