...
import lu.uni.fstc.proactivity.rules.moodleCoPs.M202;
...
/**
 * testing M202 and M203
 */
public class TestM202 {
...
//		Global.logger.info("AbstractMoodleDbWrapper was created as " + db.toString() + ".");
		...
		*/
	 	...
	 	final M202 rule = new M202(0);
		rule.setEngine(new ProactiveEngine (db, dbPam));

		final boolean ret = rule.execute();
		Global.logger.info("M202.execute() returned: " + ret);
